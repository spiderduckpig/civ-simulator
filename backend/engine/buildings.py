...
BUILDING_TYPES: dict[str, BuildingType] = {
    ...
    "monastery": BuildingType(
        key="monastery",
        name="Monastery",
        max_level=3,
        staffable=True,
        cost_resources={"lumber", "stone"},
        inputs={"paper": 0.5, "bread": 1.0},
        outputs={"education": 1.0, "medical_services": 1.0},
        professions={"artisan": 10},
    ),
    "school": BuildingType(
        key="school",
        ...
        staffable=True,
        cost_resources={"lumber", "stone"},
        inputs={"paper": 3.0, "bread": 2.0},
        outputs={"education": 5.0},
        professions={"professional": 10},
    ),
    "hospital": BuildingType(
        key="hospital",
        name="Hospital",
        max_level=50,
        staffable=True,
        cost_resources={"lumber", "stone"},
        inputs={"fabric": 2.0, "bread": 2.0, "education": 2.0},
        outputs={"medical_services": 5.0},
        professions={"professional": 10},
    ),
    "slums": BuildingType(
        key="slums",
        ...
        staffable=False,
        cost_resources={"lumber"},
        inputs={"lumber": 2.0, "fabric": 1.0},
        outputs={"housing": 2.0},
        professions={"worker": 10},
    ),
}
